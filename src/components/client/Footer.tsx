    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Đối tác đáng tin cậy của bạn cho nội thất cao cấp. Chúng tôi mang
              đến sự thoải mái và phong cách cho ngôi nhà của bạn với bộ sưu tập
          ...
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Nhận thông tin mới nhất về sản phẩm mới và khuyến mãi sắp tới
              </p>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          <p className="text-gray-400 text-sm">
            © 2024 Comforty. Tất cả quyền được bảo lưu.
          </p>
